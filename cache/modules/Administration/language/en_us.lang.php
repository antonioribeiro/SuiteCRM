...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_GMAILLICENSEADDON' => 'RT GSync License Add-on',
  'LBL_GMAILLICENSEADDON_LICENSE_TITLE' => 'License Configuration',
  'LBL_GMAILLICENSEADDON_LICENSE' => 'Manage and configure the license for RT GSync',
  'LBL_GSYNC_CONFIGURE_USERS_TITLE' => 'RT GSync Users Configuration',
  'LBL_GSYNC_CONFIGURE_USERS' => 'Manage and configure users for RT GSync',
);