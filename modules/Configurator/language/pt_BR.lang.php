...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_MAILMERGE_DESC' => 'Esse sinalizador deve ser marcado somente se você tiver o Plugin SuiteCRM para Microsoft&reg; Word&reg;.',
	...
	'LBL_PORTAL_ON_DESC' => 'Permite aos usuários gerenciar informações do usuário portal nos registros dos contatos. Usuários do portal podem acessar Ocorrências, Bugs, artigos da Base de Conhecimento e outros dados através da aplicação do Portal do SuiteCRM.',
	'LBL_PORTAL_ON' => 'Habilitar a Gestão de Usuários do Portal',
    ...
    'LBL_ENABLE_ACTION_MENU_DESC' => 'Selecione para exibir a tela de Detalhes e as ações do subpanel em uma lista suspensa. Se não for selecionado, as ações serão exibidas como botões separados.',
    ...
    'LOCK_HOMEPAGE_HELP'=>'Esta configuração é para evitar <BR>1) a adição de qualquer dashlet à página inicial, <BR>2) arrastar e soltar o dashlet para customizar seu posicionamento nas páginas iniciais.',
	...
	'SHOW_DOWNLOADS_TAB_HELP' =>'Quando selecionada, a guia de Download aparecerá nas Configurações do Usuário e disponibilizará aos usuários o acesso aos plug-ins do SuiteCRM plug-ins e outros arquivos disponíveis.',
...
<br>
Caso escolha por não inserir sua fonte no PDF, o arquivo PDF gerado será menor. Mas, uma fonte substituta será utilizada, caso a fonte não estiver instalada no sistema de seu leitor.
<br><br>
Para adicionar uma fonte PDF ao SuiteCRM, é necessário seguir os passos 1 e 2 na seção "DOCS" da documentação Fontes TCPDF disponível no <a href="http://www.tcpdf.org" target="_blank">Site TCPDF</a>.
<br><br>Os utilitários pfm2afm e ttf2ufm estão disponíveis em fontes/utilitários do pacote TCPDF, que você pode baixar na seção "DOWNLOAD" do <a href="http://www.tcpdf.org" target="_blank">Site TCPDF</a>.
<br><br>Carregue o arquivo de métrica gerado pelo passo 2 e o arquivo de sua fonte abaixo.
BSOFR',
...
// Wizard
    ...
    'LBL_WIZARD_FINISH' => 'Clique em <b>continuar</b> para configurar suas configurações de usuário. <br/>< br / > para definir configurações adicionais do sistema, clique <a href="index.php?module=Administration&action=index" target="_blank"> aqui</a>.',
