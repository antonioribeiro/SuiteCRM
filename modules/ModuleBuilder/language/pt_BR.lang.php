...
$mod_strings = array(
    ...
    'LBL_POWERED_BY_SUGAR' => 'Distribuído por SugarCRM' /*for 508 compliance fix*/,
    'help' => array(
        'package' => array(
...
//Revert Module labels
    ...
    'LBL_POPHELP_VALIDATE_US_PHONE' => 'Selecionar para validar este campo para a introdução de um número de telefone de 10 dígitos,<br> com margem para o código de país 1,<br> e aplicar o formato dos E.U.A. ao número de telefone quando o registo for gravado.<br> O seguinte formato irá ser aplicado: (xxx) xxx-xxxx.',
