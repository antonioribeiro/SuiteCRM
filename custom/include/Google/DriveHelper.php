<?php
	...
	class DriveHelper
	{
		...
		*/
		 ...
		 * @param string $lastSync containing last sync date
		 * @return array $ids ids of documents modified now to avoid sending back these files for modification to GOOGLE
		*/
		 ...
		 * @param int $userID doument's assigned user id
		 * @param Google_DriveService $service Drive API service instance.
		 * @return true if modification/creation successfull false if modification/creation fail
		*/
		 ...
		 * @return array formated array accordingly
		*/
